  ...
  <main class="animated-main-background">
    <div class="container mx-auto px-6 py-8">
      <div class="animate-on-scroll">
        ...
        <p class="mt-2 text-gray-600">Menampilkan {{ $searchCount }} hasil yang sesuai dengan pencarian Anda di <span class="font-bold text-indigo-600">{{ ucfirst($city) }}</span>.</p>
      </div>
      <div class="mt-8 flex flex-col lg:flex-row gap-8">
        <aside class="w-full lg:w-1/4 animate-on-scroll delay-100">
          ...
          <form action="" method="GET" class="bg-white/60 backdrop-blur-xl p-6 rounded-2xl shadow-lg border border-white/20 sticky top-28">
        ...
        <section class="w-full lg:w-3/4">
          <div class="space-y-6">
            @forelse ($vehicleDatas as $data)
              ...
              <div class="bg-white rounded-xl shadow-lg overflow-hidden transition-all duration-300 hover:shadow-2xl hover:-translate-y-1 transform animate-on-scroll delay-{{ ($loop->index % 3) * 100 + 200 }} {{ $data->is_premium > 0 ? 'border-2 border-yellow-400' : '' }}">
            ...
            @empty
              <div
                ...
                <p class="mt-2">Tidak ada kendaraan yang cocok dengan filter pencarian Anda. Coba ubah filter atau perluas area pencarian.</p>
              </div>
            @endforelse
