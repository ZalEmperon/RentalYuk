...
<header class="bg-white shadow-md sticky top-0 z-50">
  <nav class="container mx-auto px-6 py-4 flex justify-between items-center">
    ...
    <div class="hidden md:flex space-x-8 items-center">
      ...
      <a href="/" class="text-gray-600 hover:text-indigo-600 transition duration-300">Beranda</a>
  ...
  <div id="mobile-menu" class="hidden md:hidden px-6 pt-2 pb-4">
    ...
    {{-- <a href="/#motor" class="block text-gray-600 hover:text-indigo-600 py-2">Sewa Motor</a> --}}
      <a href="/" class="block text-gray-600 hover:text-indigo-600 py-2">Beranda</a>
