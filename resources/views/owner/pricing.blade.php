...
<main class="min-h-screen w-full animated-silver-black-bg font-sans flex items-center justify-center py-12 px-4">
  ...
  {{-- [MODIFIKASI] Kontainer utama sekarang memiliki border animasi --}}
  <div class="max-w-4xl w-full mx-auto relative rounded-2xl bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 p-1 shadow-2xl animated-border">
...
<style>
  ...
  /* [TAMBAHAN] CSS untuk Border Animasi */
  .animated-border {
