    ...
    <div
      ...
      <div class="w-full h-full bg-gradient-to-br from-white to-slate-50 rounded-[15px] p-8 md:p-12">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8 items-stretch">
          ...
          <div
            class="flex flex-col p-8 bg-slate-100 border rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 animate-on-scroll delay-100">
          ...
          <div
            class="relative flex flex-col p-8 bg-gradient-to-br from-gray-800 to-black text-white rounded-2xl shadow-2xl transform scale-105 animate-on-scroll delay-200">
            <div class="absolute top-0 right-0 -mt-3 mr-3">
              <span
                class="inline-flex items-center px-3 py-1 rounded-full text-sm font-bold bg-indigo-500 text-white">Paling
                Populer</span>
            </div>
            <form action="/owner/pricing" method="POST" class="flex flex-col h-full">
              @csrf
              ...
              <ul class="space-y-3 mb-6">
                <li class="flex items-center"><svg class="w-5 h-5 mr-2 text-green-400"
                    xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                    <path fill-rule="evenodd"
                      d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z"
                      clip-rule="evenodd" />
                  </svg>5 Iklan Aktif</li>
                <li class="flex items-center"><svg class="w-5 h-5 mr-2 text-green-400"
                    xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                    <path fill-rule="evenodd"
                      d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z"
                      clip-rule="evenodd" />
                  </svg>Statistik Iklan</li>
              </ul>
              <button type="submit"
          ...
          <div
            class="flex flex-col p-8 bg-slate-100 border rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 animate-on-scroll delay-300">
            <form action="/owner/pricing" method="POST" class="flex flex-col h-full">
              @csrf
